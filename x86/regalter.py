...
# Constant(s)
APP_NAME = "Regalter (32-bit)" # The default title for Regalter that
...
''', "About Regalter",
    ...
    def update_names_button(self):
        ...
        mbox(0,
                "Registered owner and registered organization names have been successfully changed. Click the \'Launch winver.exe\' button to view the changes made.",
                "Update successful",
